          ...
          if (this.ioCheckPanel) {
            ...
            this.ioCheckPanel = vscode.window.createWebviewPanel(
              ...
              columnToShowIn || vscode.ViewColumn.One,
              {
                ...
                localResourceRoots: [
                  vscode.Uri.joinPath(extensionContext.extensionUri, "src"),
            ...
            this.ioCheckPanel.webview.onDidReceiveMessage(async (message) => {
          ...
          switch (message.command) {
            ...
            case "digitalWrite": {
              ...
              await ConnectionManager.instance
                .executeCommand(
                  id,
                  "echo " + value + " >> /sys/kernel/dout_drv/DOUT_DATA",
                )
                .then(() => {
                  this.ioCheckPanel?.webview.postMessage({
                    command: "buttonClick",
