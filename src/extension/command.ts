  ...
  public static createCommands() {
        ...
        async function (element: Controller | undefined) {
          ...
          await vscode.window.withProgress(
            ...
            async (progress) => {
              progress.report({
                increment: 0,
                message: "Checking if port forwarding is enabled...",
              });

              const pfEnabled = await ConnectionManager.instance.executeCommand(
              ...
              if (pfEnabled !== "true") {
                progress.report({
                  increment: 10,
                  message: "Port forwarding is not enabled. Enabling...",
                });
              ...
              progress.report({
                increment: 20,
                message: "Waiting for the debugger to connect...",
              });
    ...
    commands.push(
      vscode.commands.registerCommand(
        ...
        async (controller: Controller | undefined, showConfirmation = true) => {
