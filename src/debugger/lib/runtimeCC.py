...
while True:
    if not run:
        ...
        procRun = subprocess.Popen(["python3", "-m", "debugpy", "--listen", "0.0.0:5678", "/home/user/python_bootapplication/main.py"], start_new_session=True, stdout=subprocess.PIPE, stderr=subprocess.PIPE)
        stopped = True
